...
// FFCLocationManager
#define COCOAPODS_POD_AVAILABLE_FFCLocationManager
#define COCOAPODS_VERSION_MAJOR_FFCLocationManager 0
#define COCOAPODS_VERSION_MINOR_FFCLocationManager 1
#define COCOAPODS_VERSION_PATCH_FFCLocationManager 0
